...
(function () {
  ...
  window.API = {
    ...
    auth: {
      ...
      registerOtp: (data) => request('POST', '/auth/register-otp', data),
      verifyRegisterOtp: (data) => request('POST', '/auth/verify-register-otp', data),
      resendRegisterOtp: (data) => request('POST', '/auth/resend-register-otp', data),
